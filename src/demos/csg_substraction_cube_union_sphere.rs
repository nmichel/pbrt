...
pub fn build_scene(config: &Config) -> (Scene, Box<dyn Camera>) {
    ...
    let mat_plain_orange = Arc::new(Lambertian::new(Arc::new(PlainColor::new(colors::ORANGE))));

    scene
        .add_object(Arc::new(Transformed::new(
            Arc::new(Simple::new(Arc::new(Sphere::new(0.25)), mat_plain_orange.clone())),
        ...
        .add_object(Arc::new(Transformed::new(
            Arc::new(Simple::new(Arc::new(Sphere::new(0.3)), mat_plain_orange.clone())),
            Box::new(Transform::translation(Vector3f::new(0.0, 0.0, 0.5))),
        )))
        .add_object(Arc::new(Transformed::new(
            Arc::new(Simple::new(Arc::new(Sphere::new(0.3)), mat_plain_orange.clone())),
